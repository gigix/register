 ...
 */
@Controller
@RequestMapping(value = "module/register/registerLink.form")
public class RegisterModuleFormController {
	
	/** Logger for this class and subclasses */
	protected final Log log = LogFactory.getLog(getClass());
	
	/** Success form view name */
	private final String SUCCESS_FORM_VIEW = "/module/register/registerList";
